            ...
            if (i == 0) {
                for (long k = 0; k < pw; k++) {
                    if (dna.charAt((int) k) == 'A')
                        ...
                        arr[1]++;
                    else if (dna.charAt((int) k) == 'G')
                        arr[2]++;
                    else if (dna.charAt((int) k) == 'T')
                        arr[3]++;
                }
            } else {
                if (dna.charAt((int) i - 1) == 'A')
                    arr[0]--;
                else if (dna.charAt((int) i - 1) == 'C')
                    arr[1]--;
                else if (dna.charAt((int) i - 1) == 'G')
                    arr[2]--;
